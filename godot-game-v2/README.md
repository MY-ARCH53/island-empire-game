...
> **v2 — aktif geliştirme.** `godot-game/` (v1) taban alınarak oluşturuldu;
> bundan sonraki tüm yeni eklentiler burada. v1 dondurulmuş bir referans
> noktası olarak ayrı klasörde duruyor, elle senkronize edilmiyor.
