                      ...
                      chat.map((msg: any) => {
                        ...
                        return (
                          <div key={msg.id} style={{ display: 'flex', flexDirection: 'column', alignItems: isMe ? 'flex-end' : 'flex-start' }}>
                            {!isMe && (
                              <div style={{ fontSize: 11, color: '#64748b', marginBottom: 2, marginLeft: 4 }}>{msg.username}</div>
                            )}
                            <div style={{
                    ...
                    {storage.map((s: any) => {
                      ...
                      return (
                        <div key={s.resource_type} style={{
                          ...
                          <div style={{ fontSize: 20, fontWeight: 800, color: rm.color, marginTop: 4 }}>{fmt(s.amount)}</div>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div key={g.id} style={{
                  ...
                  {!myGuild && (
                    <button
                      ...
                      style={{
                        background: g.member_count >= g.member_limit ? 'rgba(100,116,139,0.12)' : 'rgba(139,92,246,0.2)',
                        ...
                        cursor: g.member_count >= g.member_limit ? 'not-allowed' : 'pointer',
          ...
          <div style={S.card}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <button
                ...
                style={{
                  background: loading || guildName.length < 3 ? 'rgba(100,116,139,0.2)' : 'linear-gradient(135deg,#7c3aed,#a78bfa)',
